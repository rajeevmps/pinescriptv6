...
The `//@` compiler annotations used for versioning, library documentation, and script metadata.

**10 entries** · Source: [Pine Script® v6 Reference Manual](https://www.tradingview.com/pine-script-reference/v6/)
...
- [`@param`](#param)
- [`@returns`](#returns)
- [`@strategy_alert_message`](#strategyalertmessage)
- [`@type`](#type)
- [`@variable`](#variable)
- [`@version=`](#version)
