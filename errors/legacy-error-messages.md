<!--
Source: https://www.tradingview.com/pine-script-docs/error-messages/ (retired)
This page was removed from the v6 User Manual; /error-messages/ now redirects to
/pine-script-docs/errors/overview/. Kept here because the errors it describes
still occur in Pine Script v6 and the current "Errors and warnings" section
does not yet cover them.
-->

# Error messages (legacy page)

> **About this page**
>
> TradingView retired this page when it introduced the coded
> [Errors and warnings](overview.md) section. The errors below still occur in v6,
> but the text is a snapshot of the older page and is not maintained upstream.
> For currently documented errors, read [`overview.md`](overview.md) first.
